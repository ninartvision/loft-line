...
const usp = {
  cards:[
    {title_ka:'ხარისხის გარანტია',title_en:'Quality Guarantee',text_ka:'5 წლიანი გარანტია ყველა ხის ავეჯზე',text_en:'5-year warranty on all wood furniture',icon:`<path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/>`},
